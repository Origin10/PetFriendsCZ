        ...
        <form th:action="@{/book/updateBook}" method="post" enctype="multipart/form-data" class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input id="title" type="text" name="title" value="${book.title}" required="required" placeholder="Title" class="form-control"/><span class="help-block">物資名稱</span>
              </div>
            </div>
            <!-- author-->
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input id="author" type="text" name="author" value="${book.author}" required="required" placeholder="Author" class="form-control"/><span class="help-block">
                  物資
                  的製造商</span>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input id="publisher" type="text" name="publisher" value="${book.publisher}" placeholder="Publisher" class="form-control"/><span class="help-block">
                  物資
                  的經銷商</span>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input id="inStockNumber" value="${book.inStockNumber}" type="number" name="inStockNumber" placeholder="Number of in-stock copies" class="form-control"/><span class="help-block">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <textarea id="description" name="description" rows="5" value="${book.description}" th:text="${book.description}" placeholder="Description" class="form-control"><span class="help-block">物資的相關描述</span></textarea>
              </div>
            </div>
            <!-- upload image-->
            <div class="form-group">
