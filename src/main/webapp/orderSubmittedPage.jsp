  ...
  <body>
    ...
    <div class="container">
      <div style="margin-bottom: -100px;" class="row">
        <div class="col-xs-8">
          <h2 class="section-headline"><span>使用者帳號</span></h2>
        </div>
      ...
      <div style="margin-top: 10px;" class="row">
        <div class="col-xs-12">
          <div class="alert alert-success">
            <h3><i aria-hidden="true" style="color: limegreen;" class="fa fa-check"></i> 已收到您的訂單。</h3>
            <h4>預計收貨日期為：<span th:text="${estimatedDeliveryDate}"></span></h4>
          </div>
          <h3>項目列表</h3>
          <div th:each="cartItem : ${cartItemList}" class="row">
            ...
            <div class="col-xs-6">
              <div style="margin-left: 50px;"><a th:href="@{/bookDetail?id=}+${cartItem.book.id}">
                  <h4 th:text="${cartItem.book.title}"></h4></a></div>
            </div>
            <div class="col-xs-2">
