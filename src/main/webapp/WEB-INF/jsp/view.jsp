...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<div id="form_frame">
		...
		<!-- End -->
		<h2>${insert.userName}，您好，您所填寫的「${fromName}」資料已成功登記。</h2>
		...
		<form>
			<table>
				...
				<tr>
					<td>上傳圖片：</td>
					<td><c:forEach var="photourls"
							items="${insert.adoptPhotoUrlBeans}" end="1">
							<img
								src="${pageContext.request.contextPath}${photourls.photoUrl}"
								width="200">
						</c:forEach></td>
				</tr>
				<tr>
