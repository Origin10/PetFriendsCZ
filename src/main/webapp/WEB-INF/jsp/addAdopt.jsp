...
<link href="css/nav-setting.css" rel="stylesheet">
<style>
	.container {
    font-size: 1.5rem;
    }
...
<script type="text/javascript">
    $(document).ready(function(){
    	...
    	//選項回填
    	$("#PetType").val('${param.PetType}');
    	$("#FindCity").val('${param.FindCity}');
    	$("#PetGender").val('${param.PetGender}');
    	setFindDistrict($("#FindCity").val());
        $("#FindDistrict").val('${param.FindDistrict}');
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="container" id="formEnity">
        <form:form method="POST" modelAttribute="adoptBean" enctype="multipart/form-data" action="addAdopt" class="form-horizontal">
        	<h2 class="formH2 col-sm-offset-3">請選擇表單種類，並詳細填寫下列資訊</h2>
        	
        	<div class="PetFormSet">
            <label class="radio-inline">
                <form:radiobutton path="PetForm" id="PetForm" value="1"/> 協尋
            </label>
            <label class="radio-inline">
                <form:radiobutton path="PetForm" id="PetForm" value="2"/> 拾獲，找原主人
            </label>
            <label class="radio-inline">
                <form:radiobutton path="PetForm" id="PetForm" value="3"/> 拾獲，找新主人
            </label>
            <label class="radio-inline">
                <form:radiobutton path="PetForm" id="PetForm" value="4"/> 不擬續養，送養
            </label>
            </div>
				...
				<div class="form-group">
					<div class="g-recaptcha col-sm-offset-4 col-sm-4" data-sitekey="6LcdTSYUAAAAAASBrO3iUgf1OgbxtSv5S_wnVB-K"></div>
					<div class="col-sm-4">
						<button type="submit" class="btn btn-primary">新增</button>
						<button type="button" class="btn btn-default" onclick="clearForm()">清除</button>
						<button type="button" class="btn btn-default"  onclick="TestForm()">Fast</button>
					</div>
				</div>	
				</form:form>
    </div>
